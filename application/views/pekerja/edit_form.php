      ...
      <!-- Alert end -->
        <div class="card bg-light mx-auto my-3">
          ...
          <form action="" method="post" enctype="multipart/form-data" >
            <h4>Ubah Data Pekerja</h4>
            <input type="hidden" name="id" value="<?php echo $pekerja->pekerja_id?>" />
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input
                ...
                name="tgl_lahir"
                value="<?php echo $pekerja->tgl_lahir ?>"
              />
              <div class="invalid-feedback">
            ...
            <div class="mb-3">
              ...
              <input
                ...
                name="kontrak"
                value="<?php echo $pekerja->kontrak ?>"
              />
              <div class="invalid-feedback">
            ...
            <div class="mb-3">
              ...
              <input
                ...
                name="jabatan"
                value="<?php echo $pekerja->jabatan ?>"
              />
              <div class="invalid-feedback">
