      ...
      <!-- Alert end -->
        <div class="card bg-light mx-auto my-3">
          ...
          <form action="" method="post" enctype="multipart/form-data" >
            ...
            <input type="hidden" name="id" value="<?php echo $dokumentasi->dokumentasi_id?>" />
            <div class="mb-3">
              ...
              <input
                ...
                name="gbr_material"
              />
              <input type="hidden" name="old_image" value="<?php echo $dokumentasi->gbr_material ?>">
            ...
            <div class="mb-3">
              ...
              <input
                ...
                value="<?php echo $dokumentasi->tgl_dokumentasi ?>"
              />
              <div class="invalid-feedback">
            ...
            <div class="mb-3">
              ...
              <input
                ...
                name="nm_apartemen"
                value="<?php echo $dokumentasi->nm_apartemen ?>"
              />
              <div class="invalid-feedback">
            ...
            <div class="mb-3">
              ...
              <input
                ...
                name="nm_pekerja"
                value="<?php echo $dokumentasi->nm_pekerja ?>"
              />
              <div class="invalid-feedback">
            ...
            <div class="mb-3">
              ...
              <input
                ...
                name="lokasi"
                value="<?php echo $dokumentasi->lokasi ?>"
              />
              <div class="invalid-feedback">
